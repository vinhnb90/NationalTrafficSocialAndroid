...
/**
 * Created by nankai on 1/11/2018.
 */

public class VideoStreamsView implements GLSurfaceView.Renderer {

private static VideoStreamsView instance = null;
...
private VideoStreamsView(GLSurfaceView surface) {
...
private static class YuvImageRenderer implements VideoRenderer.Callbacks {
    ...
    public static void setView(GLSurfaceView surface) {
        Log.v(TAG, "VideoStreamsView.setView");
        instance = new VideoStreamsView(surface);
    }
    ...
    public static YuvImageRenderer create(
        ...
        synchronized (instance.yuvImageRenderers) {
            if (instance.onSurfaceCreatedCalled) {
                // onSurfaceCreated has already been called for VideoStreamsView -
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        Log.v(TAG, "VideoStreamsView.onSurfaceCreated");
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        Log.v(TAG, "VideoStreamsView.onSurfaceChanged: " +
                width + " x " + height + "  ");
