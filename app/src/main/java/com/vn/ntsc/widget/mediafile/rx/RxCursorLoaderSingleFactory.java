...
import static com.vn.ntsc.widget.mediafile.rx.RxCursorLoader.TAG;
import static com.vn.ntsc.widget.mediafile.rx.RxCursorLoader.isDebugLoggingEnabled;
    ...
    private static final class CursorLoaderOnSubscribeSingle
        ...
        public void subscribe(final SingleEmitter<Cursor> emitter) {
            if (isDebugLoggingEnabled()) {
                LogUtils.d(TAG, mQuery.toString());
            }
