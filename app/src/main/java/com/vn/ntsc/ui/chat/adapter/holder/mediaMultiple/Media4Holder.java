 ...
 * for send/receive file include 4
 */
public class Media4Holder extends MediaHolder {
    ...
    public Media4Holder(int gender, String avatarUrl, View itemView, MessageOnEventListener mMessageOnEventListener) {
