...
public class ImageViewTouchBase extends android.support.v7.widget.AppCompatImageView {
    ...
    public ImageViewTouchBase(Context context) {
        super(context);
        if (context instanceof ImageViewTouch.IteractorGestureListenerA)
            init((ImageViewTouch.IteractorGestureListenerA) context);
        else
    ...
    protected void init(ImageViewTouch.IteractorGestureListenerA callback) {
    ...
    public void zoomToCenter(float scale) {
        zoomTo(scale);
    }
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    e.printStackTrace();
                    Log.e(TAG, "run update scroll x y error : " + e.getMessage());
                }
