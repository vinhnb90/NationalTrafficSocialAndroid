package com.nankai.designlayout.progress;
...
import com.nankai.designlayout.progress.indicators.BallPulseIndicator;
...
public class LoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor=a.getColor(R.styleable.LoadingIndicatorView_indicatorColor, Color.RED);
