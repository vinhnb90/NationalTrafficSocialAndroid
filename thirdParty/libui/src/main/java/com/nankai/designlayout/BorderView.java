package com.nankai.designlayout;
...
/**
 * Created by ducng on 11/08/2017.
 */

@SuppressWarnings("unused")
public class BorderView extends LinearLayout {

    public static final String TAG = BorderView.class.getSimpleName();
    ...
    public BorderView(Context context, AttributeSet attrs) {
        ...
        TypedArray attrsArray = context.obtainStyledAttributes(attrs, R.styleable.BorderViewsAttrs, 0, 0);
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        mDefaultBackgroundColor = attrsArray.getColor(R.styleable.BorderViewsAttrs_fb_defaultColor, mDefaultBackgroundColor);
        mFocusBackgroundColor = attrsArray.getColor(R.styleable.BorderViewsAttrs_fb_focusColor, mFocusBackgroundColor);
        mDisabledBackgroundColor = attrsArray.getColor(R.styleable.BorderViewsAttrs_fb_disabledColor, mDisabledBackgroundColor);

        mEnabled = attrsArray.getBoolean(R.styleable.BorderViewsAttrs_android_enabled, true);

        mDisabledTextColor = attrsArray.getColor(R.styleable.BorderViewsAttrs_fb_disabledTextColor, mDisabledTextColor);
        mDisabledBorderColor = attrsArray.getColor(R.styleable.BorderViewsAttrs_fb_disabledBorderColor, mDisabledBorderColor);
        mDefaultTextColor = attrsArray.getColor(R.styleable.BorderViewsAttrs_fb_textColor, mDefaultTextColor);
        // if default color is set then the icon's color is the same (the default for icon's color)
        mDefaultIconColor = attrsArray.getColor(R.styleable.BorderViewsAttrs_fb_iconColor, mDefaultTextColor);

        mDefaultTextSize = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_textSize, mDefaultTextSize);
        mDefaultTextSize = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_android_textSize, mDefaultTextSize);

        mDefaultTextGravity = attrsArray.getInt(R.styleable.BorderViewsAttrs_fb_textGravity, mDefaultTextGravity);

        mBorderColor = attrsArray.getColor(R.styleable.BorderViewsAttrs_fb_borderColor, mBorderColor);
        mBorderWidth = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_borderWidth, mBorderWidth);

        mRadius = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_radius, mRadius);

        mRadiusTopLeft = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_radiusTopLeft, mRadius);
        mRadiusTopRight = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_radiusTopRight, mRadius);
        mRadiusBottomLeft = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_radiusBottomLeft, mRadius);
        mRadiusBottomRight = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_radiusBottomRight, mRadius);

        mFontIconSize = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_fontIconSize, mFontIconSize);

        mIconPaddingLeft = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_iconPaddingLeft, mIconPaddingLeft);
        mIconPaddingRight = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_iconPaddingRight, mIconPaddingRight);
        mIconPaddingTop = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_iconPaddingTop, mIconPaddingTop);
        mIconPaddingBottom = (int) attrsArray.getDimension(R.styleable.BorderViewsAttrs_fb_iconPaddingBottom, mIconPaddingBottom);

        mTextAllCaps = attrsArray.getBoolean(R.styleable.BorderViewsAttrs_fb_textAllCaps, false);
        mTextAllCaps = attrsArray.getBoolean(R.styleable.BorderViewsAttrs_android_textAllCaps, false);

        mGhost = attrsArray.getBoolean(R.styleable.BorderViewsAttrs_fb_ghost, mGhost);
        mUseSystemFont = attrsArray.getBoolean(R.styleable.BorderViewsAttrs_fb_useSystemFont, mUseSystemFont);

        String text = attrsArray.getString(R.styleable.BorderViewsAttrs_fb_text);

        if (text == null) { //no fb_text attribute
            text = attrsArray.getString(R.styleable.BorderViewsAttrs_android_text);
        }

        mIconPosition = attrsArray.getInt(R.styleable.BorderViewsAttrs_fb_iconPosition, mIconPosition);

        String fontIcon = attrsArray.getString(R.styleable.BorderViewsAttrs_fb_fontIconResource);

        String iconFontFamily = attrsArray.getString(R.styleable.BorderViewsAttrs_fb_iconFont);
        String textFontFamily = attrsArray.getString(R.styleable.BorderViewsAttrs_fb_textFont);

        Drawable icon = null;
        try {
            mIconResource = attrsArray.getDrawable(R.styleable.BorderViewsAttrs_fb_iconResource);
    ...
    private void initializeButtonContainer() {
        ...
        // https://github.com/medyo/BorderViews/issues/100 
    ...
    /**
     * Set Icon Position
     * Use the global variables (BorderView.POSITION_LEFT, BorderView.POSITION_RIGHT, BorderView.POSITION_TOP, BorderView.POSITION_BOTTOM)
     *
    ...
    /**
     * Override setEnabled and rebuild the BorderView view
    ...
    /**
     * Return TextView Object of the BorderView
     *
    ...
    /**
     * Return Icon Font of the BorderView
     *
     * @return TextView Object
     */
